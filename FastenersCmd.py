...
FSScrewCommandTable = {
    ...
    "ISO7040": (translate("FastenerCmd", "Prevailing torque type hexagan nuts (with non-metallic insert)"), NutGroup, NutParameters),
    "ISO7041": (translate("FastenerCmd", "Prevailing torque type hexagan nuts (with non-metallic insert), style 2"), NutGroup, NutParameters),
    ...
    "ISO10511": (translate("FastenerCmd", "Prevailing torque type hexagan thin nuts (with non-metallic insert)"), NutGroup, NutParameters),
    "ISO10512": (translate("FastenerCmd", "Prevailing torque type hexagan nuts (with non-metallic insert) - fine pitch thread"), NutGroup, NutParameters),
