...
FSScrewCommandTable = {
    ...
    "ISO4762": (translate("FastenerCmd", "ISO4762 Hexagon socket head cap screw"), HexagonSocketGroup, ScrewParametersLC, "ISO"),
    ...
    "DIN84": (translate("FastenerCmd", "DIN84 (superseded by ISO 1207) Slotted cheese head screw"), SlottedGroup, ScrewParametersLC, "DIN"),
    ...
    "ISO8673": (translate("FastenerCmd", "ISO 4032 Hexagon regular nuts (style 1) with metric fine pitch thread — Product grades A and B"), NutGroup, NutParameters, "ISO"),
    "ISO8674": (translate("FastenerCmd", "ISO ISO8674 Hexagon high nuts (style 2) with metric fine pitch thread "), NutGroup, NutParameters, "ISO"),
    ...
    "DIN917": (translate("FastenerCmd", "DIN917 Cap nuts, thin style"), NutGroup, NutParameters, "DIN"),
    ...
    "DIN6340": (translate("FastenerCmd", "DIN6340 Washers for clamping devices"), WasherGroup, WasherParameters, "DIN"),
