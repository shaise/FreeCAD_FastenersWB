...
FSScrewCommandTable = {
    ...
    "ISO2340": (translate("FastenerCmd", "ISO 2340 Clevis pins without head"), PinGroup, PinParameters, "ISO"),
    "ISO2341": (translate("FastenerCmd", "ISO 2341 Clevis pins with head"), PinGroup, PinParameters, "ISO"),
