...
FSScrewCommandTable = {
    ...
    "ISO4017": ("ISO 4017 Hex head screw", translate("FastenerCmd", "Hex head"), ScrewParametersLC),
    "ISO4014": ("ISO 4014 Hex head bolt", translate("FastenerCmd", "Hex head"), ScrewParametersLC), 
    "EN1662": ("EN 1662 Hexagon bolt with flange, small series", translate("FastenerCmd", "Hex head"), ScrewParametersLC), 
    "EN1665": ("EN 1665 Hexagon bolt with flange, heavy series", translate("FastenerCmd", "Hex head"), ScrewParametersLC), 
    "DIN571": ("DIN 571 Hex head wood screw", translate("FastenerCmd", "Hex head"), ScrewParametersLC), 

    "ISO4762": ("ISO4762 Hexagon socket head cap screw", translate("FastenerCmd", "Hexagon socket"), ScrewParametersLC), 
    "DIN7984": ("DIN 7984 Hexagon socket head cap screws with low head", translate("FastenerCmd", "Hexagon socket"), ScrewParametersLC), 
    "DIN6912": ("DIN 6912 Hexagon socket head cap screws with low head with centre", translate("FastenerCmd", "Hexagon socket"), ScrewParametersLC), 
    "ISO7380-1": ("ISO 7380 Hexagon socket button head screw", translate("FastenerCmd", "Hexagon socket"), ScrewParametersLC), 
    "ISO7380-2": ("ISO 7380 Hexagon socket button head screws with collar", translate("FastenerCmd", "Hexagon socket"), ScrewParametersLC), 
    "ISO10642": ("ISO 10642 Hexagon socket countersunk head screw", translate("FastenerCmd", "Hexagon socket"), ScrewParametersLC), 
    "ISO7379": ("ISO 7379 Hexagon socket head shoulder screw", translate("FastenerCmd", "Hexagon socket"), ScrewParametersLC), 
    "ISO4026": ("ISO 4026 Hexagon socket set screws with flat point", translate("FastenerCmd", "Hexagon socket"), ScrewParametersLC), 
    "ISO4027": ("ISO 4027 Hexagon socket set screws with cone point", translate("FastenerCmd", "Hexagon socket"), ScrewParametersLC), 
    "ISO4028": ("ISO 4028 Hexagon socket set screws with dog point", translate("FastenerCmd", "Hexagon socket"), ScrewParametersLC), 
    "ISO4029": ("ISO 4029 Hexagon socket set screws with cup point", translate("FastenerCmd", "Hexagon socket"), ScrewParametersLC), 

    "ISO14579": ("ISO 14579 Hexalobular socket head cap screws", translate("FastenerCmd", "Hexalobular socket"), ScrewParametersLC), 
    "ISO14580": ("ISO 14580 Hexalobular socket cheese head screws", translate("FastenerCmd", "Hexalobular socket"), ScrewParametersLC), 
#    "ISO14581": ("ISO 14581 Hexalobular socket countersunk flat head screws", translate("FastenerCmd", "Hexalobular socket"), ScrewParametersLC), 
    "ISO14582": ("ISO 14582 Hexalobular socket countersunk head screws, high head", translate("FastenerCmd", "Hexalobular socket"), ScrewParametersLC), 
    "ISO14583": ("ISO 14583 Hexalobular socket pan head screws", translate("FastenerCmd", "Hexalobular socket"), ScrewParametersLC), 
    "ISO14584": ("ISO 14584 Hexalobular socket raised countersunk head screws", translate("FastenerCmd", "Hexalobular socket"), ScrewParametersLC), 

    "ISO2009": ("ISO 2009 Slotted countersunk flat head screw", translate("FastenerCmd", "Slotted"), ScrewParametersLC), 
    "ISO2010": ("ISO 2010 Slotted raised countersunk head screw", translate("FastenerCmd", "Slotted"), ScrewParametersLC), 
    "ISO1580": ("ISO 1580 Slotted pan head screw", translate("FastenerCmd", "Slotted"), ScrewParametersLC), 
    "ISO1207": ("ISO 1207 Slotted cheese head screw", translate("FastenerCmd", "Slotted"), ScrewParametersLC), 

    "DIN967": ("DIN 967 Cross recessed pan head screws with collar", translate("FastenerCmd", "H cross"), ScrewParametersLC), 
    "ISO7045": ("ISO 7045 Pan head screws type H cross recess", translate("FastenerCmd", "H cross"), ScrewParametersLC), 
    "ISO7046": ("ISO 7046 Countersunk flat head screws H cross r.", translate("FastenerCmd", "H cross"), ScrewParametersLC), 
    "ISO7047": ("ISO 7047 Raised countersunk head screws H cross r.", translate("FastenerCmd", "H cross"), ScrewParametersLC), 
    "ISO7048": ("ISO 7048 Cheese head screws with type H cross r.", translate("FastenerCmd", "H cross"), ScrewParametersLC), 

    "ISO4032": ("ISO 4032 Hexagon nuts, Style 1", translate("FastenerCmd", "Nut"), NutParameters), 
    "ISO4033": ("ISO 4033 Hexagon nuts, Style 2", translate("FastenerCmd", "Nut"), NutParameters), 
    "ISO4035": ("ISO 4035 Hexagon thin nuts, chamfered", translate("FastenerCmd", "Nut"), NutParameters), 
#    "ISO4036": ("ISO 4035 Hexagon thin nuts, unchamfered", translate("FastenerCmd", "Nut"), NutParameters), 
    "EN1661": ("EN 1661 Hexagon nuts with flange", translate("FastenerCmd", "Nut"), NutParameters), 
    "DIN917": ("DIN917 Cap nuts, thin style", translate("FastenerCmd", "Nut"), NutParameters), 
    "DIN1587": ("DIN 1587 Cap nuts", translate("FastenerCmd", "Nut"), NutParameters), 
    "DIN557": ("DIN 557 Square nuts", translate("FastenerCmd", "Nut"), NutParameters), 
    "DIN562": ("DIN 562 Square nuts", translate("FastenerCmd", "Nut"), NutParameters), 
    "DIN985": ("DIN 985 Nyloc nuts", translate("FastenerCmd", "Nut"), NutParameters), 

    "ISO7089": ("ISO 7089 Washer", translate("FastenerCmd", "Washer"), WasherParameters), 
    "ISO7090": ("ISO 7090 Plain Washers, chamfered - Normal series", translate("FastenerCmd", "Washer"), WasherParameters), 
#    "ISO7091": ("ISO 7091 Plain washer - Normal series Product Grade C", translate("FastenerCmd", "Washer"), WasherParameters),   # same as 7089??
    "ISO7092": ("ISO 7092 Plain washers - Small series", translate("FastenerCmd", "Washer"), WasherParameters), 
    "ISO7093-1": ("ISO 7093-1 Plain washers - Large series", translate("FastenerCmd", "Washer"), WasherParameters), 
    "ISO7094": ("ISO 7094 Plain washers - Extra large series", translate("FastenerCmd", "Washer"), WasherParameters), 
    "NFE27-619": ("NFE27-619 Countersunk washer", translate("FastenerCmd", "Washer"), WasherParameters), 

# Inch

    "ASMEB18.2.1.6": ("ASME B18.2.1 UNC Hex head screws", translate("FastenerCmd", "Hex head"), ScrewParametersLC), 
    "ASMEB18.2.1.8": ("ASME B18.2.1 UNC Hex head screws with flange", translate("FastenerCmd", "Hex head"), ScrewParametersLC), 

    "ASMEB18.3.1A": ("ASME B18.3 UNC Hex socket head cap screws", translate("FastenerCmd", "Hexagon socket"), ScrewParametersLC), 
    "ASMEB18.3.1G": ("ASME B18.3 UNC Hex socket head cap screws with low head", translate("FastenerCmd", "Hexagon socket"), ScrewParametersLC), 
    "ASMEB18.3.2": ("ASME B18.3 UNC Hex socket countersunk head screws", translate("FastenerCmd", "Hexagon socket"), ScrewParametersLC), 
    "ASMEB18.3.3A": ("ASME B18.3 UNC Hex socket button head screws", translate("FastenerCmd", "Hexagon socket"), ScrewParametersLC), 
    "ASMEB18.3.3B": ("ASME B18.3 UNC Hex socket button head screws with flange", translate("FastenerCmd", "Hexagon socket"), ScrewParametersLC), 
    "ASMEB18.3.4": ("ASME B18.3 UNC Hexagon socket head shoulder screws", translate("FastenerCmd", "Hexagon socket"), ScrewParametersLC), 
    "ASMEB18.3.5A": ("ASME B18.3 UNC Hexagon socket set screws with flat point", translate("FastenerCmd", "Hexagon socket"), ScrewParametersLC), 
    "ASMEB18.3.5B": ("ASME B18.3 UNC Hexagon socket set screws with cone point", translate("FastenerCmd", "Hexagon socket"), ScrewParametersLC), 
    "ASMEB18.3.5C": ("ASME B18.3 UNC Hexagon socket set screws with dog point", translate("FastenerCmd", "Hexagon socket"), ScrewParametersLC), 
    "ASMEB18.3.5D": ("ASME B18.3 UNC Hexagon socket set screws with cup point", translate("FastenerCmd", "Hexagon socket"), ScrewParametersLC), 

    "ASMEB18.6.3.1A": ("ASME B18.6.3 UNC slotted countersunk flat head screws", translate("FastenerCmd", "Slotted"), ScrewParametersLC), 

    "ASMEB18.5.2": ("ASME B18.5 UNC Round head square neck bolts", translate("FastenerCmd", "Other head"), ScrewParametersLC), 

    "ASMEB18.2.2.1A": ("ASME B18.2.2 UNC Machine screw nuts", translate("FastenerCmd", "Nut"), NutParameters), 
    "ASMEB18.2.2.4A": ("ASME B18.2.2 UNC Hexagon nuts", translate("FastenerCmd", "Nut"), NutParameters), 
    "ASMEB18.2.2.4B": ("ASME B18.2.2 UNC Hexagon thin nuts", translate("FastenerCmd", "Nut"), NutParameters), 

    "ASMEB18.21.1.12A": ("ASME B18.21.1 UN washers, narrow series", translate("FastenerCmd", "Washer"), WasherParameters), 
    "ASMEB18.21.1.12B": ("ASME B18.21.1 UN washers, regular series", translate("FastenerCmd", "Washer"), WasherParameters), 
    "ASMEB18.21.1.12C": ("ASME B18.21.1 UN washers, wide series", translate("FastenerCmd", "Washer"), WasherParameters), 

    "ScrewTap": ("Metric threaded rod for tapping holes", translate("FastenerCmd", "ThreadedRod"), RodParameters), 
    "ScrewTapInch": ("Inch threaded rod for tapping holes", translate("FastenerCmd", "ThreadedRod"), RodParameters), 
    "ScrewDie": ("Tool object to cut external metric threads", translate("FastenerCmd", "ThreadedRod"), RodParameters), 
    "ScrewDieInch": ("Tool object to cut external non-metric threads", translate("FastenerCmd", "ThreadedRod"), RodParameters), 
    "ThreadedRod": ("DIN 975 metric threaded rod", translate("FastenerCmd", "ThreadedRod"), RodParameters), 
    "ThreadedRodInch": ("UNC threaded rod", translate("FastenerCmd", "ThreadedRod"), RodParameters), 
    "PEMPressNut": ("PEM Self Clinching nut", translate("FastenerCmd", "PEM Inserts"), PEMPressNutParameters), 
    "PEMStandoff": ("PEM Self Clinching standoff", translate("FastenerCmd", "PEM Inserts"), PEMStandoffParameters), 
    "PEMStud": ("PEM Self Clinching stud", translate("FastenerCmd", "PEM Inserts"), ScrewParameters),
    "PCBStandoff": ("Wurth WA-SSTII  PCB standoff", translate("FastenerCmd", "PEM Inserts"), PCBStandoffParameters), 
    "PCBSpacer": ("Wurth WA-SSTII PCB spacer", translate("FastenerCmd", "PEM Inserts"), PCBSpacerParameters), 
    "IUTHeatInsert": ("IUT[A/B/C] Heat Staked Metric Insert", translate("FastenerCmd", "PEM Inserts"), NutParameters), 
}
