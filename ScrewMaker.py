...
screwTables = {
    ...
    'ISO10642': ("Screw",  FsData["iso10642def"],  FsData["iso10642length"], FsData["iso10642range"], 3, 7, "makePanHeadScrew"),
    ...
    'ISO7046':  ("Screw",  FsData["iso2009def"],   FsData["iso7045length"],  FsData["iso7046range"],  4, 5, "makePanHeadScrew"),
    'ISO7047':  ("Screw",  FsData["iso2009def"],   FsData["iso7045length"],  FsData["iso7046range"],  4, 5, "makePanHeadScrew"),
    ...
    'ISO14582': ("Screw",  FsData["iso14582def"],  FsData["iso14582length"], FsData["iso14582range"], 4, 5, "makePanHeadScrew"),
    'ISO14583': ("Screw",  FsData["iso14583def"],  FsData["iso7045length"],  FsData["iso7046range"],  -1, 0, "makePanHeadScrew"),
    'ISO14584': ("Screw",  FsData["iso14584def"],  FsData["iso7045length"],  FsData["iso14584range"],  3, 5, "makePanHeadScrew"),
    ...
    'DIN1587':  ("Nut",    FsData["din1587def"],    None,          None,           -1, 0, ""),
    ...
    'ASMEB18.3.2': ("Screw", FsData["asmeb18.3.2def"], FsData["inch_fs_length"], FsData["asmeb18.3.2range"], -1, 0, "makePanHeadScrew"),
    ...
    'ASMEB18.21.1.12A': ("Washer", FsData["asmeb18.21.1.12def"], None, None, -1, 0, "makeWasher"),
    'ASMEB18.21.1.12B': ("Washer", FsData["asmeb18.21.1.12def"], None, None, -1, 0, "makeWasher"),
    'ASMEB18.21.1.12C': ("Washer", FsData["asmeb18.21.1.12def"], None, None, -1, 0, "makeWasher"),
...
class FSScrewMaker(Screw):
    ...
    def createFastener(self, type, diam, len, threadType, shapeOnly, leftHanded):
        ...
        family = screwTables[type][0]
        function = screwTables[type][6]
        return self.createScrew(type, diam, len, threadType, family, function, shapeOnly, leftHanded)
