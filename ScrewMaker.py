...
screwTables = {
    ...
    'ISO7379':  ("Screw",  FsData["iso7379def"],   FsData["iso7379length"],  FsData["iso7379range"],  2, 0),
    ...
    'IFI111':   ("Screw", FsData["ifi111def"], FsData["inch_fs_length"], FsData["ifi111range"], -1, 0),
