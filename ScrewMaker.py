...
screwTables = {
    #            name,    def table,   length table,  range table,  diam pos*, K pos**, function
    'ISO4017':  ("Screw",  FsData["iso4017head"],  FsData["iso4017length"],  FsData["iso4017range"],  -1, 0, "makeHexHeadBolt"),
    'ISO4014':  ("Screw",  FsData["iso4014head"],  FsData["iso4014length"],  FsData["iso4014range"],  -1, 0, "makeHexHeadBolt"),
    'EN1662':   ("Screw",  FsData["en1662def"],    FsData["en1662length"],   FsData["en1662range"],   -1, 0, "makeHexHeadWithFlunge"),
    'EN1665':   ("Screw",  FsData["en1665def"],    FsData["en1665length"],   FsData["en1665range"],   -1, 0, "makeHexHeadWithFlunge"),
    'ISO2009':  ("Screw",  FsData["iso2009def"],   FsData["iso2009length"],  FsData["iso2009range"],  4, 5, "makeSlottedScrew"),
    'ISO2010':  ("Screw",  FsData["iso2009def"],   FsData["iso2009length"],  FsData["iso2009range"],  4, 5, "makeSlottedScrew"),
    'ISO4762':  ("Screw",  FsData["iso4762def"],   FsData["iso4762length"],  FsData["iso4762range"],  -1, 0, "makeCylinderHeadScrew"),
    'ISO10642': ("Screw",  FsData["iso10642def"],  FsData["iso10642length"], FsData["iso10642range"], 3, 7, "makeCountersunkHeadScrew"),
    'ISO1207':  ("Screw",  FsData["iso1207def"],   FsData["iso1207length"],  FsData["iso1207range"],  -1, 0, "makeCheeseHeadScrew"),
    'ISO1580':  ("Screw",  FsData["iso1580def"],   FsData["iso2009length"],  FsData["iso2009range"],  -1, 0, "makeSlottedScrew"),
    'ISO7045':  ("Screw",  FsData["iso7045def"],   FsData["iso7045length"],  FsData["iso7045range"],  -1, 0, "makePanHeadScrew"),
    'ISO7046':  ("Screw",  FsData["iso2009def"],   FsData["iso7045length"],  FsData["iso7046range"],  4, 5, "makeCountersunkHeadScrew"),
    'ISO7047':  ("Screw",  FsData["iso2009def"],   FsData["iso7045length"],  FsData["iso7046range"],  4, 5, "makeCountersunkHeadScrew"),
    'ISO7048':  ("Screw",  FsData["iso7048def"],   FsData["iso7048length"],  FsData["iso7048range"],  -1, 0, "makeCheeseHeadScrew"),
    'DIN967':   ("Screw",  FsData["din967def"],    FsData["din967length"],   FsData["din967range"],   -1, 0, "makeButtonHeadScrew"),
    'ISO7379':  ("Screw",  FsData["iso7379def"],   FsData["iso7379length"],  FsData["iso7379range"],  -1, 0, "makeShoulderScrew"),
    'ISO7380-1':("Screw",  FsData["iso7380def"],   FsData["iso7380length"],  FsData["iso7380range"],  -1, 0, "makeButtonHeadScrew"),
    'ISO7380-2':("Screw",  FsData["iso7380_2def"], FsData["iso7380length"],  FsData["iso7380range"],  -1, 0, "makeButtonHeadScrew"),
    'ISO14579': ("Screw",  FsData["iso14579def"],  FsData["iso14579length"], FsData["iso14579range"], -1, 0, "makeCylinderHeadScrew"),
    'ISO14580': ("Screw",  FsData["iso14580def"],  FsData["iso14580length"], FsData["iso1207range"],  -1, 0, "makeCheeseHeadScrew"),
    'ISO14582': ("Screw",  FsData["iso14582def"],  FsData["iso14582length"], FsData["iso14582range"], 4, 5, "makeCountersunkHeadScrew"),
    'ISO14583': ("Screw",  FsData["iso14583def"],  FsData["iso7045length"],  FsData["iso7046range"],  -1, 0, "makePanHeadScrew"),
    'ISO14584': ("Screw",  FsData["iso14584def"],  FsData["iso7045length"],  FsData["iso14584range"],  3, 5, "makeCountersunkHeadScrew"),
    'DIN7984':  ("Screw",  FsData["din7984def"],   FsData["din7984length"],  FsData["din7984range"], -1, 0, "makeCylinderHeadScrew"),
    'DIN6912':  ("Screw",  FsData["din6912def"],   FsData["din6912length"],  FsData["din6912range"], -1, 0, "makeCylinderHeadScrew"),
    'DIN571':   ("Screw",  FsData["din571head"],   FsData["din571length"],   FsData["din571range"],  -1, 0, "makeWoodScrew"),
    'ISO7089':  ("Washer", FsData["iso7089def"],   None,          None,           -1, 0, "makeWasher"),
    'ISO7090':  ("Washer", FsData["iso7090def"],   None,          None,           -1, 0, "makeWasher"),
    'ISO7091':  ("Washer", FsData["iso7091def"],   None,          None,           -1, 0, "makeWasher"),
    'ISO7092':  ("Washer", FsData["iso7092def"],   None,          None,           -1, 0, "makeWasher"),
    'ISO7093-1':("Washer", FsData["iso7093def"],   None,          None,           -1, 0, "makeWasher"),
    'ISO7094':  ("Washer", FsData["iso7094def"],   None,          None,           -1, 0, "makeWasher"),
    'NFE27-619':("Washer", FsData["NFE27-619def"], None,          None,           -1, 0, "makeWasher"),
    'ISO4026':  ("Screw",  FsData["iso4026def"],   FsData["iso4026length"],  FsData["iso4026range"],   -1, 0, "makeSetScrew"),
    'ISO4027':  ("Screw",  FsData["iso4026def"],   FsData["iso4026length"],  FsData["iso4026range"],   -1, 0, "makeSetScrew"),
    'ISO4028':  ("Screw",  FsData["iso4028def"],   FsData["iso4028length"],  FsData["iso4028range"],   -1, 0, "makeSetScrew"),
    'ISO4029':  ("Screw",  FsData["iso4026def"],   FsData["iso4026length"],  FsData["iso4026range"],   -1, 0, "makeSetScrew"),
    'ISO4032':  ("Nut",    FsData["iso4032def"],   None,          None,           -1, 0, "makeHexNut"),
    'ISO4033':  ("Nut",    FsData["iso4033def"],   None,          None,           -1, 0, "makeHexNut"),
    'ISO4035':  ("Nut",    FsData["iso4035def"],   None,          None,           -1, 0, "makeHexNut"),
    ...
    'ASMEB18.2.2.4A': ("Nut", FsData["asmeb18.2.2.4def"], None, None, -1, 0, "makeHexNut"),
    'ASMEB18.2.2.4B': ("Nut", FsData["asmeb18.2.2.4def"], None, None, -1, 0, "makeHexNut"),
    'ASMEB18.3.1A': ("Screw", FsData["asmeb18.3.1adef"], FsData["inch_fs_length"], FsData["asmeb18.3.1arange"], -1, 0, "makeCylinderHeadScrew"),
    'ASMEB18.3.1G': ("Screw", FsData["asmeb18.3.1gdef"], FsData["inch_fs_length"], FsData["asmeb18.3.1arange"], -1, 0, "makeCylinderHeadScrew"),
    'ASMEB18.3.2': ("Screw", FsData["asmeb18.3.2def"], FsData["inch_fs_length"], FsData["asmeb18.3.2range"], -1, 0, "makeCountersunkHeadScrew"),
    'ASMEB18.3.3A': ("Screw", FsData["asmeb18.3.3adef"], FsData["inch_fs_length"], FsData["asmeb18.3.3arange"], -1, 0, "makeButtonHeadScrew"),
    'ASMEB18.3.3B': ("Screw", FsData["asmeb18.3.3bdef"], FsData["inch_fs_length"], FsData["asmeb18.3.3brange"], -1, 0, "makeButtonHeadScrew"),
    'ASMEB18.3.4': ("Screw", FsData["asmeb18.3.4def"], FsData["inch_fs_length"], FsData["asmeb18.3.4range"], -1, 0, "makeShoulderScrew"),
    'ASMEB18.3.5A': ("Screw", FsData["asmeb18.3.5def"], FsData["inch_fs_length"], FsData["asmeb18.3.5range"], -1, 0, "makeSetScrew"),
    'ASMEB18.3.5B': ("Screw", FsData["asmeb18.3.5def"], FsData["inch_fs_length"], FsData["asmeb18.3.5range"], -1, 0, "makeSetScrew"),
    'ASMEB18.3.5C': ("Screw", FsData["asmeb18.3.5def"], FsData["inch_fs_length"], FsData["asmeb18.3.5range"], -1, 0, "makeSetScrew"),
    'ASMEB18.3.5D': ("Screw", FsData["asmeb18.3.5def"], FsData["inch_fs_length"], FsData["asmeb18.3.5range"], -1, 0, "makeSetScrew"),
    'ASMEB18.6.3.1A': ("Screw", FsData["asmeb18.6.3.1adef"], FsData["inch_fs_length"], FsData["asmeb18.6.3.1arange"], -1, 0, "makeSlottedScrew"),
...
class FSScrewMaker(Screw):
    def FindClosest(self, type, diam, len):
        ...
        if type not in screwTables:
            return diam, len
        name, diam_table, len_table, range_table, table_pos, k_pos, function = screwTables[type]
